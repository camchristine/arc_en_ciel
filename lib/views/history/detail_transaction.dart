...
class _DetailsTransactionState extends State<DetailsTransaction> {
  ...
  initState() {
    ...
    super.initState();
    inspect(widget
        .paiementDetails); //  this is the material super constructor for init state to link your instance initState to the global initState context
  }
  ...
  Widget build(BuildContext context) {
    ...
    var totalFrais = widget.paiementDetails!.fraisOperateur +
        widget.paiementDetails!.fraisEliah;
    return Scaffold(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          AutoSizeText(
                            "${widget.paiementDetails!.montantInitial.toString()} F",
                            textAlign: TextAlign.center,
                            style: const TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w500,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          AutoSizeText(
                            widget.paiementDetails!.dateTransaction.toString(),
                            textAlign: TextAlign.center,
                            style: const TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w500,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          AutoSizeText(
                            widget.paiementDetails!.reference.toString(),
                            textAlign: TextAlign.center,
                            style: const TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w500,
